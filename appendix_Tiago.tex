...
\begin{table}[ht]
  ...
  \caption{Performance characteristics (mean $\pm$ SD) for PCA fed LDA, PCA fed XGBoost and raw data into XGBoost methods for four-classification prediction with 10-fold cross-validation as found by Azevedo (unpublished).}
\end{table}