...
XGBoost uses an ensemble of regression T-trees (trees with T leaves) which produce $K$ additive functions $f_k$, enabling output prediction according to:
\begin{equation}
