...
\begin{figure}
    ...
    \caption{Different methods of connecting layers in a neural network. a) shows multiple fully-connected layers. From \cite{alzubaidi_review_2021}. b) shows the action of 1D and 2D CNN kernels. From \cite{shenfield_novel_2020} and \cite{dumoulin_guide_2018} respectively. c) shows an outline of the scaled dot-product attention and multi-head attention mechanisms, from \cite{vaswani_attention_2023} and the transformer encoder block \cite{dosovitskiy_image_2021}.}
