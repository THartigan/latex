...
\begin{minted}{python3}
# Incorporate the Kullback-Leibler loss prevents the divergence of probability distributions
...
def elbo_supervised(x, x_rec, mu, logvar, y_logits, y_true, beta=1, label_smoothing=0.25):
    ...
    ce = nn.functional.cross_entropy(y_logits, y_true, label_smoothing=label_smoothing, reduction='sum') / x.size(0)
...
\subsection{Reparamaterisaiton Trick}
\begin{minted}{python3}
